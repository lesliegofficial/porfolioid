...
function buildEPK(epk) {
  ...
  const svgIcons = {
    ...
    amazon: '<svg viewBox="0 0 24 24"><path d="M13.958 10.09c0 1.232.029 2.256-.591 3.351-.502.891-1.301 1.438-2.186 1.438-1.214 0-1.922-.924-1.922-2.292 0-2.692 2.415-3.182 4.7-3.182v.685zm3.186 7.705c-.209.189-.512.201-.745.076C15.258 16.919 14.65 16.213 14 15.4c-1.807 2.168-3.088 2.817-5.429 2.817-2.769 0-4.929-1.71-4.929-5.132 0-2.674 1.45-4.494 3.513-5.383 1.79-.789 4.285-.928 6.199-1.146V6.13c0-.731.057-1.596-.373-2.228-.375-.565-1.095-.797-1.731-.797-1.174 0-2.225.607-2.483 1.862-.052.28-.256.556-.537.569l-3.005-.326c-.253-.058-.534-.258-.461-.642C5.398 2.061 8.322.5 11.534.5c1.645 0 3.796.438 5.097 1.687 1.645 1.534 1.488 3.579 1.488 5.808v5.26c0 1.582.656 2.276 1.275 3.132.217.305.264.668-.013.893-.693.578-1.925 1.652-2.603 2.255l-.634-.74zm3.042 6.208c-7.847 4.773-12.828 2.054-16.066-.073-.324-.21-.035-.499.354-.335 3.545 1.388 7.434.886 10.132-.228.272-.11.565.014.761.209.451.451.745.677.997.79.364.165.405.424.116.585.051-.04.101-.082.145-.124l-.44-.824z"/></svg>',
  ...
  const platformColors = {
    ...
    amazon:'#C9A84C', threads:'#000000', x:'#000000', snapchat:'#FFFC00',
  ...
  const platformBg = {
    ...
    amazon:'rgba(201,168,76,0.12)', threads:'rgba(0,0,0,0.85)', x:'rgba(0,0,0,0.85)',

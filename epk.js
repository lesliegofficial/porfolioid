...
function buildEPK(epk) {
  ...
  const svgIcons = {
    ...
    amazon: '<svg viewBox="0 0 100 100"><text y=".9em" font-size="80" font-family="Arial Black,Arial,sans-serif" font-weight="900">a</text><path d="M15 82 Q50 95 85 82" stroke="#FF9900" stroke-width="6" fill="none" stroke-linecap="round"/><path d="M82 78 L85 82 L79 83" fill="#FF9900" stroke="none"/></svg>',

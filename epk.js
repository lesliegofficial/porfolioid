      ...
      <div class="ch3-wrap">
        ...
        <div class="ch3-grid">
          ...
          <div class="ch3-card" onclick="filterCreditsByCategory('founderbuilder')" style="cursor:pointer">
            <div class="ch3-img"><img src="https://res.cloudinary.com/djj8xe3gx/image/upload/v1781631424/career-highlights/founder-builder.jpg" alt="Founder & Builder" loading="lazy"></div>
            <div class="ch3-body">

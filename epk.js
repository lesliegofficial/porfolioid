...
function buildEPK(epk) {
  ...
  const svgIcons = {
    ...
    amazon: '<svg viewBox="0 0 24 24"><path d="M15.93 17.09c-.16.12-.39.13-.57.03C13.8 15.71 11.47 15.2 8.71 15.2c-1.5 0-3.03.2-4.47.55-.14.04-.29-.02-.38-.12-.09-.1-.1-.26-.03-.38.24-.56 1.05-2.45 1.05-2.45a.44.44 0 01.47-.27c.03 0 .16.01.17.02l.15.02c1.57.21 3.2.32 4.83.32 3.2 0 6.01-.53 8.34-1.56a.4.4 0 01.52.22c.09.22.04.47-.17.6-.73.49-1.53.91-1.86 1.1l.05.08c.47.63.93 1.26 1.38 1.9.18.25.13.6-.12.78zm1.2-2.94c-.77.55-1.5.97-1.79 1.16l-.04-.06c-.43-.61-.89-1.23-1.35-1.85a.54.54 0 01.14-.77c.87-.61 1.56-1.37 1.56-1.37.12-.14.1-.34-.04-.46a.32.32 0 00-.45.04s-.71.78-1.6 1.4c-.27.19-.62.15-.85-.08C12.16 11.34 11.43 10 11.43 10s-.41-.73-.67-1.19a.33.33 0 00-.58.01c-.24.46-.62 1.2-.62 1.2s-.72 1.41-1.47 1.67c-.24.08-.5-.01-.63-.22l-.02-.04c-.1-.17-.12-.38-.04-.56a16.8 16.8 0 001.16-3.32C9.12 6.1 10.49 5.5 12 5.5c1.52 0 2.88.6 3.45 1.55.52.86.68 2.05.45 3.17a7.14 7.14 0 01-.77 2.07c.51-.15 1.07-.17 1.58.01.49.17.83.57.96 1.08.14.57-.01 1.16-.54 1.52z"/></svg>',
  ...
  const amazonBannerHTML = amazonUrl ? `
    <a href="${amazonUrl}" class="ch-amazon-banner" target="_blank" rel="noopener">
      <span class="ch-amazon-icon">
        <span class="ch-amazon-letter">a</span>
      </span>

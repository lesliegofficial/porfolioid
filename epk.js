  ...
  document.getElementById('epkContent').innerHTML = `
    ...
    <div class="hero">
      ...
      <div class="hero-content">
        ...
        <div class="hero-presence-bar" onclick="document.getElementById('connect')?.scrollIntoView({behavior:'smooth'}); setTimeout(()=>{ const b=document.getElementById('connectBody'); const h=document.querySelector('#connect .collapsible-header'); if(b&&b.style.display==='none') toggleSection('connectBody',h); },400);" style="cursor:pointer">
          <div class="hero-presence-top-row">
            ...
            <span class="hero-presence-explore">Explore →</span>
          </div>
          <h3 class="hero-presence-title">My Digital Presence</h3>

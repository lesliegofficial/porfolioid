...
function openAwardModal(idx) {
  ...
  document.getElementById('awardModalContent').innerHTML = `
    ...
    <div style="display:flex;flex-direction:column;gap:0.5rem">
      ${a.certUrl ? `<div style="margin-top:1rem"><div style="font-family:var(--font-mono);font-size:0.55rem;letter-spacing:0.12em;text-transform:uppercase;color:var(--gray);margin-bottom:0.5rem">📄 Certificate</div><object data="${a.certUrl}" type="application/pdf" style="width:100%;height:480px;border:1px solid rgba(201,168,76,0.2);background:#1C1C1C"><img src="${a.certUrl.replace(/\.(pdf|ai)$/i, '.jpg')}" style="width:100%;max-height:480px;object-fit:contain;background:#1C1C1C" onerror="this.outerHTML='<div style=\'padding:2rem;text-align:center;color:var(--gray);font-family:var(--font-mono);font-size:0.7rem\'>Preview not available in this browser</div>'"></object></div>` : ''}

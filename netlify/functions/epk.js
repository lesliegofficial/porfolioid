  ...
  try {
    ...
    if (event.httpMethod === 'POST') {
      ...
      if (action === 'signup') {
        ...
        const newUser = { id: `user_${Date.now()}`, firstName: body.firstName, lastName: body.lastName, email: body.email, slug: body.slug, password: body.password, createdAt: new Date().toISOString(), epk: body.epk };
